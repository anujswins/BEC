      ...
      {isPermitted ? (
        <View style={{flex: 1}}>
          <CameraKitCameraScreen
            ...
            flashImages={{
              // Flash button images
              on: require('../../assets/client_feedback.png'),
              off: require('../../assets/add.png'),
              auto: require('../../assets/add.png'),
            }}
            cameraFlipImage={require('../../assets/add.png')}
            captureButtonImage={require('../../assets/add.png')}
          />
        </View>
      ) : (
