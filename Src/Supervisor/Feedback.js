...
//                              <View style={{ height: '100%', width: '80%', backgroundColor: 'transparent',marginTop:'2%' }}>
...
// </View>
//          <View style={{  height: '52%', width:'100%', backgroundColor: "white",
...
// justifyContent:"space-evenly", alignItems:"center",   borderTopWidth:1,borderTopColor:'grey',
//                      height:'10%'}}>

// <Image style={{height: '50%', width: '7%'}} 
// source = {require('../../assets/client_feedback.png')}></Image>
// <Text style={{ color: 'grey' }}>{item.Feedback}</Text>

// <Text style={{ color: 'grey' }}> {item.CreatedOn} {item.UserName}</Text>
// <Image style={{height:'50%', width: '10%'}} 
//                     source = {require('../../assets/dropdown_icon.png')}></Image>
// </View>  
//         ))} 
//         </ScrollView> 
