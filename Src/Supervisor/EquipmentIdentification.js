            ...
            <SafeAreaView style={{flex: 1, backgroundColor: '#FFFFFF'}}>
                ...
                <View style={{height: '9%', width: '100%', backgroundColor: '#008BD0'}}>
                    ...
                    <View style={{
                        ...
                        }} onPress={() => this.backBtnOnPress(this.state.selectId)}>

                            <Image style={{height: '30%', width: '53%', resizeMode: 'cover'}}
                ...
                <View style={{height: '82%', width: '100%', backgroundColor: '#FFFFFF'}}>
                    ...
                    <View style={{height: '78%', width: '100%', backgroundColor: 'transparent'}}>
                        ...
                        {this.state.selectId ? <View style={{
                                height: 'auto',
                                width: '90%',
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity activeOpacity={0.5}
                                                          onPress={() => this.machineIdAvailable(true)}>
                                            <View style={{
                                                height: '100%',
                                                width: '100%',
                                                flexDirection: 'row',
                                                backgroundColor: '#015EA1',
                                            }}>
                                                <View style={{
                                                    height: '100%',
                                                    width: '35%',
                                                    ...
                                                    <Image source={require('../../assets/tick_icon.png')} style={{
                                                        resizeMode: 'contain',
                                                        height: '60%',
                                                        backgroundColor: 'transparent',
                                                    }}/>
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity activeOpacity={0.5}
                                                          onPress={() => this.machineIdAvailable(false)}>
                                            <View style={{
                                                height: '100%',
                                                width: '100%',
                                                flexDirection: 'row',
                                                ...
                                                <View style={{
                                                    ...
                                                    <Image source={require('../../assets/crossicon.png')} style={{
                                                        resizeMode: 'contain',
                                                        height: '60%',
                                                        backgroundColor: 'transparent',
                                                    }}/>
