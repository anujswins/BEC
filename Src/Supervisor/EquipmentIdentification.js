...
export default class Equipment_Identification extends Component {
    ...
    // --------------AppStorageChooseJobType----------------------------
    ChooseJobTypeStorage = (JobTypeId) => {

        AppStorage.ChooseJobTypeKey(key.CHOOSE_JOB_TYPE, JSON.stringify(JobTypeId)).then(() => {
            console.log("json_response_chooseJobType.data**", JobTypeId)
        });
...
console.log("*********",this.state.ChooseBtnData)
    ...
    onPress = (JobTypeId) => {
        if(JobTypeId){
            // alert(JobTypeId)
            this.ChooseJobTypeStorage(JobTypeId)
                         ...
                         renderItem={({item})=>(
                             <View style={{backgroundColor:'transparent',}}>
                                <TouchableOpacity activeOpacity={0.6} style={{height:hp('5.6%'),width:wp('25%'),alignItems:'center',justifyContent:'center',backgroundColor: '#008CD0', borderBottomWidth: 5, borderBottomColor: "#074667",marginTop:hp('5%') }} 
                                 onPress={() => this.onPress(item.JobTypeId)}>  
...
//     }
//     // --------------AppStorageChooseJobType----------------------------
//     ChooseJobTypeStorage = (json_response_chooseJobType) => {

//         AppStorage.ChooseJobTypeKey(key.CHOOSE_JOB_TYPE, JSON.stringify(json_response_chooseJobType.data)).then(() => {
//             console.log("json_response_chooseJobType.data**", json_response_chooseJobType.data)
//         });
...
//                 var ChooseBtnData = json_response_chooseJobType.data.data.jobTypeMainRespone.jobTypeResponse
          
//                 for (i = 0; i < ChooseBtnData.length; i++) {
//                     this.state.response_Json.push(ChooseBtnData[i].JobType)

//                 }
//                 console.log("****response_Json*****", this.state.response_Json)
//                 this.state.textBtn1 = this.state.response_Json[0]
//                 this.state.textBtn2 = this.state.response_Json[1]
...
//                                     <TouchableOpacity activeOpacity={0.6} onPress={() => this.onPress(true)}>
//                                         <View style={{ alignItems: 'center', justifyContent: 'center' }}>
//                                             <Text style={{ fontSize: hp('2.2'), color: "#FFFFFF", paddingHorizontal: '4%', backgroundColor: '#008CD0', paddingVertical: '2.5%', borderBottomWidth: 4, borderBottomColor: "#074667" }}>{this.state.textBtn1}</Text>
//                                         </View>
//                                     </TouchableOpacity>

//                                 </View>
//                                 <View style={{ justifyContent: "flex-start", }}>
//                                     <TouchableOpacity activeOpacity={0.6} onPress={() => this.onPress(false)}>
//                                         <View style={{ alignItems: 'center', justifyContent: 'center' }}>
//                                             <Text style={{ fontSize: hp('2.2'), color: "#FFFFFF", textAlign: "center", paddingHorizontal: '5%', backgroundColor: '#008CD0', paddingVertical: '2.5%', borderBottomWidth: 4, borderBottomColor: "#074667" }}>{this.state.textBtn2}</Text>
//                                         </View>
//                                     </TouchableOpacity>
//                                 </View>
//                             </View>
