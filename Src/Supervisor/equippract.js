    ...
    constructor(props) {
        ...
        this.state = {
            ...
            data:[{
                themeId: 4,
                themeName: "Green",
                "themeColor": "linear-gradient(to right, rgba(48,201,173,1) 0%, rgba(48,201,173,1) 43%, rgba(0,166,144,1) 64%, rgba(0,166,144,1) 100%)",
                "logo": "http://ditstekdemo.com/floristappdev/assets/images/logo.png",
                "appcolor": "['#30c9ad', '#00a690','#00a690']",
                "mainColor": "#00a691"
    ...
    render() {
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: "#FFFFFF", }}>
               <LinearGradient colors={this.state.data} style={styles.linearGradient}>
