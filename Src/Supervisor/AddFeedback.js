...
//    console.log('GetFeedbackPriority try==', json_response.data.data.globalCodeMainResponse.
//    globalCodeResponse);
...
//    let json_response = await AuthService.CreateFeedback(this.state.jobId,this.state.feedbackType,
//     this.state.feedbackPriority,this.state.feedback,this.state.userId
...
// elevation:20}}>
// <Text style={{textAlign:"justify",padding:15}}>{(this.props.navigation.getParam('datasend'))}</Text>
//   </View>
// </View>
// {/* <View style={{ height: '7%', width: '100%', backgroundColor: "yellow",
// }}>
...
// <View style={{ height: '7%', width: '100%', backgroundColor: "white",justifyContent:"center",
// paddingHorizontal:'7%'}}>

// <TouchableOpacity style={{width:'100%',height: '80%',backgroundColor:"white",justifyContent:"center"}}
...
// <View style={{height:'28%', width:'90%', backgroundColor:'white',
//                                 marginLeft:'5%',
//                                 marginTop:'45%',elevation:20}}>
//         <View style={{ width:'80%',height:'30%',backgroundColor:'white',
//                                   justifyContent:'center'}}>
//                                 <Text style={{fontSize:20, color:"#008AD2", fontWeight:"bold",
//                                  textAlign:"center"}}>
//                                     Select FeedBack Type
//                                 </Text>
//                                 </View>
...
//               onPress={(value1, index) => {console.log("val",value1)
...
//              <TouchableOpacity onPress={()=>{this.setState({choosecategory:false})
//                                 this.setState({showModal1:false})}}>
//                                 <View style={{ width:'90%',height:'30%',backgroundColor:'white', 
//                                 alignItems:'flex-end', justifyContent:'flex-end', marginTop:'8%'}}>
//                                 <Text style={{fontSize:18, color:"#008AD2", fontWeight:"bold",
//                                  }}>
//                                     CHOOSE
//                                 </Text>
//                                 </View>
...
//               animation={true}
//               buttonSize={10}
//               // labelStyle={{ fontSize: hp('1.9%'), marginRight: wp('7%'),}}
//               onPress={(value, index) => {console.log("val",value)
//               this.state.showtext1=value
//               this.setState({ Priority: value })
//               }}
//               // radioStyle={{paddingRight: 20, marginVertical:hp('1%')}}
//               // wrapStyle={{marginVertical:hp('9%')}}
              

//             />
//                                 <View style={{ width:'90%',height:'20%',backgroundColor:'white',
 ...
 console.log('GetFeedbackPriority catch', e.response);
    ...
    Fun_GetFeedbackCreate = async () => {
        try {
            ...
            console.log('GetFeedbackCreate try', json_response.data);
