...
class AddFeedback extends Component {
 ...
 console.log('GetFeedbackPriority catch', e.response);
    ...
    Fun_GetFeedbackCreate = async () => {
        ...
        //   console.log('Job Id recived++++++++++++++++++++++=', jobId);
          var response = await AppStorage.getLoginResponse();
          
          var userId=response.userResponse.UserId;
          var FirstName=response.userResponse.FirstName;
          var lastName=response.userResponse.LastName;
          var userName=FirstName+" "+lastName;
          console.log("userId@@@@@@@@@@@@@22222", userName);
        //   pass  feedback status also 
            let json_response = await AuthService.CreateFeedback(jobId, this.create.feedbackType,
                this.create.feedbackPriority, this.create.feedback, userId,userName
