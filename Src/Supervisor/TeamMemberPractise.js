...
export default class TeamMemberPractise extends Component {
    constructor() {
        super();
        this.state = {
                    ...
                    <FlatList data={this.state.Data}
                        ...
                        renderItem={({ item }) => (
                                <View style={{ flexDirection: "row", height:hp('6%'),width:wp('90%'),borderBottomWidth: 1, borderBottomColor: "#D2D3D5", marginHorizontal: wp('5%'), backgroundColor:"transparent" }}>
                                    <View style={{ width: wp('45%'), height: hp('5.6%'), backgroundColor: "#FBFBFB", justifyContent: "center", alignItems: "flex-start", paddingLeft: '5%' }}>
                                        <Text style={{ fontSize: hp('2.1%'), color: "#333333" }}>
                                            {item.TeamMemberName}
                                        </Text>
                                    </View>
                                    <View style={{ width:wp('45%'), height: hp('5.6%'), backgroundColor: "#FBFBFB", justifyContent: "center", alignItems: "flex-start", paddingLeft: '16%'}}>
                                        <Text style={{ fontSize: hp('2.1%'), color: "#333333" }}>
                                            {item.Hours}
                                        </Text>
                                    </View>
